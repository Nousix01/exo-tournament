...
*/
        ...
        public void ArmoredSwordsmanVsViking() {
            ...
            makefood(swordsman, highlander, 0, 10);

        }

        private static void makefood(Swordsman swordsman, Highlander highlander, int expected, int expected1) {
            swordsman.engage(highlander);

            assertThat(swordsman.hitPoints()).isEqualTo(expected);
            assertThat(highlander.hitPoints()).isEqualTo(expected1);
        }
